...
class MyNav extends React.Component {
    render() {
        return (
            ...
            <Navbar collapseOnSelect expand="lg" bg="white" variant="light" className={"navbar container-fluid mb-0"} style={{ textAlign:"center", boxShadow:  "rgba(34, 35, 58, 0.0) 0px 7px 4px"}}>
                <div className={"container"}>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav" >
                        <Nav className="" >
                            ...
                            <Link to="/about" className={"nav2 nav1 mr-2 mt-2"} style={{fontSize:"0.7em" ,textAlign:"center", float: "right"}}>로그인</Link>
                            <Link to="/contact" className={"nav2 nav1 mr-2 mt-2"}  style={{fontSize:"0.7em" ,textAlign:"center", float: "right"}}>회원가입</Link>
