...
class CartSection extends React.Component {
  ...
  updateCart() {
    ...
    fetch(
      "http://211.63.89.156:8080/daylight/updatecart/" + this.state.userid,
      {
        method: "POST",
        headers: {
      ...
      <div style={{ marginBottom: "200px" }}>
        <div style={{ margin: "auto", width: "90%" }}>
          ...
          <p style={{ textAlign: "center", color: "gray" }}>
            정확한 수량과 금액을 꼭 확인해주세요.
          </p>
          <table
            className="table mt-5"
            style={{ borderBottom: "1px solid rgb(228, 225, 225)" }}
          >
            <thead>
              <tr
                className=""
                style={{
                  borderTop: "2px solid rgb(255, 191, 112)",
                  borderBottom: "1px solid #fff8f8",
                }}
              >
                <td className="">
                    ...
                    <td className="">
                      <Link to={`products/${item.productID}`}>
                        <p
                          ...
                          style={{ overflow: "visible", fontSize: "small" }}
                        >
                          {item.title}
                        </p>
                      </Link>
                      ...
                      <div className="input-group">
                        <div className="input-group-prepend">
                          <button
                            ...
                            type="button"
                            onClick={this.minus.bind(this, i, item)}
                            style={{
                              height: "22px",
                              textAlign: "center",
                              fontSize: "5px",
                        ...
                        <div className="input-group-append">
                          <button
                            className="btn btn-outline-secondary"
                            type="button"
                            onClick={this.add.bind(this, i, item)}
                            style={{
                              textAlign: "center",
                              height: "22px",
                              fontSize: "5px",
          ...
          <button
            type="button"
            className="btn btn-success mt-3 mr-1 "
