...
class Detail extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isLoggedIn: false,
      //toast가 나올지 안나올지 정하는 변수
      show: false,
      //성공 실패에 따른 다른 메세지 설정을 위한 변수
      message: "",
    };
  }
  ...
  componentDidMount() {
    //페이지가 처음 보일떄 스크롤이 가장 위쪽에 가도록 조정
    window.scrollTo(0, 0);
      ...
      <div className="container mt-5">
        ...
        >
          <div className="col-sm-5">
            <img
              src={"/images/" + this.state.product.mainimg}
          ...
          <div className="col-sm-7">
            ...
            <div className="row">
              <div className="col-12 mt-3">
                <table
                  style={{ borderBottom: "1px solid #efecec", width: "103%" }}
                >
                  <tbody>
                ...
                <div className="">
                  {/* 로그인 여부에 따라 다른 반응(로그인 페이지 이동 or toast로 성공실패 표시)
                  todo: 별개의 component로 분리*/}
                  {this.state.isLoggedIn ? (
                    <>
                      <div className="detail-toast-container">
                        <Toast
                          onClose={this.closeShow.bind(this)}
                      ...
                      <button
                        type="button"
                        className="btn btn-outline-success mt-3 mr-1 "
                        style={{ width: "40%" }}
        ...
        <div>
          <img
            className="img-fluid mt-5 mb-4 center"
            src={"/images/" + this.state.product.subimg}
            style={{
              marginLeft: "auto",
              marginRight: "auto",
              display: "block",
        ...
        <h3
          className="mt-4 pb-4 mx-5"
          style={{ color: "#5f5c5c", textAlign: "center" }}
        >
          [{this.state.product.title}]
        </h3>
        <div
          className="pb-4 mx-3 pt-4"
          style={{
            color: "#5f5c5c",
            textAlign: "center",
            borderTop: "1px solid rgb(250, 181, 140)",
            borderBottom: "1px solid rgb(250, 181, 140)",
        ...
        <h2
          className="pb-4"
          style={{ color: "#5f5c5c", textAlign: "center", marginTop: "80px" }}
        >
          <img width={25} height={25} src={"/images/checkorange.png"} />{" "}
          데이라이트 Check Point
        </h2>
        <div>
          ...
          <p className="mt-3">
            <div
              dangerouslySetInnerHTML={{ __html: this.state.product.descript1 }}
            />
          </p>
        </div>
        <div>
